#!/bin/bash
#SBATCH --job-name=elo-wo-en
#SBATCH --partition=alldlc2_gpu-h200
#SBATCH --gpus=1
#SBATCH --time=24:00:00
#SBATCH --output=/work/dlclarge2/ferreira-oellm/open-instruct/oellm/evaluations/logs/elo_wo_en_%A_%a.log
#SBATCH --requeue

# ELO Rating estimation WITHOUT English
# Same as run_elo_evaluation.sh but excludes English from languages
#
# Usage:
#   sbatch oellm/evaluations/benchmarks/run_elo_evaluation_wo_en.sh instruct-v2-step3252
#   sbatch --array=0-3 oellm/evaluations/benchmarks/run_elo_evaluation_wo_en.sh
...
if [ -n "${SLURM_ARRAY_TASK_ID:-}" ]; then
    ...
    MODEL_SYMLINK="${1:?Usage: sbatch run_elo_evaluation_wo_en.sh <model-symlink>}"
fi
...
echo ""
echo "=============================================="
echo "ELO RATING ESTIMATION (WITHOUT ENGLISH)"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "ELO Estimation (w/o en) Complete: $MODEL_SYMLINK"
echo "=============================================="
