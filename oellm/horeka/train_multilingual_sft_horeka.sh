...
# HoreKa multilingual SFT training for OLMo-3-7B (Track B experiments).
# 2 nodes × 4 H200 GPUs = 8 GPUs total.
# Continues from dolci-instruct-sft-v2-horeka checkpoint.
#
# Usage:
#   EXPERIMENT=B1-90en sbatch oellm/horeka/train_multilingual_sft_horeka.sh
#   EXPERIMENT=B2-80en SAVE_INTERVAL=200 sbatch oellm/horeka/train_multilingual_sft_horeka.sh
#   TEST_RUN=true EXPERIMENT=B1-90en sbatch oellm/horeka/train_multilingual_sft_horeka.sh
