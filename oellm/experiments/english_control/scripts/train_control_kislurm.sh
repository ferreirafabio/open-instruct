...
# Same hyperparameters as Track A multilingual experiments, but 100% English data.
#
# Configure via environment variables:
#   EXPERIMENT    - Experiment name (default: C0-100en)
#   DATASET_PATH  - Path to tokenized dataset
#   SAVE_INTERVAL - Ephemeral checkpoint save interval (default: 50)
#
# Usage:
#   EXPERIMENT=C0-100en sbatch oellm/experiments/english_control/scripts/train_control_kislurm.sh
...
WANDB_TAGS_JSON="${WANDB_TAGS_JSON:-[\"control\",\"english\",\"instruct\",\"sft\",\"7b\",\"${EXPERIMENT}\"]}"
...
echo ""
echo "=============================================="
echo "ENGLISH CONTROL SFT TRAINING"
echo "=============================================="
