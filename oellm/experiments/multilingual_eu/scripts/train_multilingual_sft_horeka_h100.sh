...
# HoreKa multilingual SFT training for OLMo-3-7B (Track B experiments) — H100 variant.
# 3 nodes × 4 H100 GPUs = 12 GPUs total. Same hyperparameters as H200 version.
# Continues from dolci-instruct-sft-v2-horeka checkpoint.
#
# Usage:
#   EXPERIMENT=B1-90en sbatch oellm/horeka/train_multilingual_sft_horeka_h100.sh
#   EXPERIMENT=B2-80en SAVE_INTERVAL=200 sbatch oellm/horeka/train_multilingual_sft_horeka_h100.sh
#   TEST_RUN=true EXPERIMENT=B1-90en sbatch oellm/horeka/train_multilingual_sft_horeka_h100.sh
