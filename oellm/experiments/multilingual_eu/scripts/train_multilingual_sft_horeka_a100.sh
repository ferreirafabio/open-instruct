...
# HoreKa multilingual SFT training for OLMo-3-7B (Track B experiments) — A100 variant.
# 4 nodes × 4 A100 GPUs = 16 GPUs total. Same hyperparameters as H200 version.
# Continues from dolci-instruct-sft-v2-horeka checkpoint.
#
# Usage:
#   EXPERIMENT=B1-90en sbatch oellm/horeka/train_multilingual_sft_horeka_a100.sh
#   EXPERIMENT=B2-80en SAVE_INTERVAL=200 sbatch oellm/horeka/train_multilingual_sft_horeka_a100.sh
#   TEST_RUN=true EXPERIMENT=B1-90en sbatch oellm/horeka/train_multilingual_sft_horeka_a100.sh
...
EXPERIMENT="${EXPERIMENT:?Usage: EXPERIMENT=B1-90en sbatch train_multilingual_sft_horeka.sh}"
...
SAVE_INTERVAL="${SAVE_INTERVAL:-200}"  # Track B default: 200

# === Multi-node ===
NUM_MACHINES=${SLURM_NNODES:-4}
GPUS_PER_NODE=4
...
WANDB_TAGS_JSON="${WANDB_TAGS_JSON:-[\"multilingual\",\"eu\",\"instruct\",\"sft\",\"7b\",\"horeka\",\"${EXPERIMENT}\"]}"
...
echo ""
echo "=============================================="
echo "HoreKa MULTILINGUAL SFT TRAINING"
echo "=============================================="
