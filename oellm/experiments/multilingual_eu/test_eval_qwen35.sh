#!/bin/bash
#SBATCH --job-name=eval-test-q35
#SBATCH --partition=testdlc2_gpu-h200
#SBATCH --gpus=1
#SBATCH --mem=128G
#SBATCH --cpus-per-task=16
#SBATCH --time=01:00:00
#SBATCH --output=/work/dlclarge2/ferreira-oellm/open-instruct/oellm/experiments/multilingual_eu/logs/eval_test_q35_%j.log

# Quick smoke test: 5 prompts to verify Qwen3.5-35B-A3B judge works
set -euo pipefail
...
python openjury/generate_and_evaluate.py \
    ...
    --judge_model "VLLM/Qwen/Qwen3.5-35B-A3B" \
    --n_instructions 5 \
    --result_folder "$PROJECT_ROOT/oellm/evaluations/benchmarks/OpenJury/results/multilingual_eu/eval-test-q35-delete-me" \
...
echo "TEST PASSED - Qwen3.5-35B-A3B works!"
